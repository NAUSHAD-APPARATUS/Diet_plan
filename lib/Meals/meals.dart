...
import 'package:diet_plan_app/firebase_options.dart'; // adjust if needed
...
class _SecondScreenState extends State<SecondScreen> {
  ...
  List<DateTime> getWeekDates(DateTime center) {
    // Build a small week window centered on the selected week (Mon..Sun)
    // We'll show Monday..Saturday as in screenshot (or 7 days) starting from Monday of this week.
          ...
          child: Column(
            ...
            children: [
              ...
              DateHeader(
                ...
                onTapChevron: () {
                  // example action: go to next week on chevron tap
                  setState(() {
...
class DatePill extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // unselected: white background with green outline and small rounded shape (like screenshot)
    return Container(
      width: 60,
